...
EMAIL_TEMPLATE_TRAINING = Template('''
<p>Hello $name,</p>
...
def send_email(to_email: EmailStr, name: str, link: str, training_title: str) -> None:
    ...
    if training_title and "certificate" in training_title.lower():
        ...
        body = EMAIL_TEMPLATE_OTHER.substitute({"name": name, "link": link, "subject": subject})
        ...
        body = EMAIL_TEMPLATE_TRAINING.substitute({"name": name, "link": link, "training_title": training_title})
