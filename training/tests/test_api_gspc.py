...
class TestGspc:
    ...
    def test_gspc_invite_success(self, goodJWT, standard_payload, fake_gspc_invite_repo):
    ...
    @patch('training.config.settings', 'JWT_SECRET', 'super_secret')
    def test_gspc_invite_parses_valid_emails(self, goodJWT, standard_payload, fake_gspc_invite_repo):
    ...
    @patch('training.config.settings', 'JWT_SECRET', 'super_secret')
    def test_gspc_invite_parses_invalid_emails(self, goodJWT, standard_payload, fake_gspc_invite_repo):
    ...
    @patch('training.config.settings', 'JWT_SECRET', 'super_secret')
    def test_gspc_invite_loggs_emails(self, goodJWT, standard_payload, fake_gspc_invite_repo):
