...
class Test_Cert_PDF:
    def test_creates_pdf_with_name_and_date(self):
        ...
        pdf_bytes = cert.generate_pdf(training_name, "Molly Bloom", "Shakespeare and Company", datetime(2023, 4, 1))
        ...
        assert any(field.field_name == 'agency' and field.field_value == 'Shakespeare and Company' for field in page.widgets())
