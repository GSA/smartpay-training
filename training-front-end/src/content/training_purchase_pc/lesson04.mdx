...
As the A/OPC, you are responsible for the setting up and maintenance of centrally billed accounts (CBAs) and individually billed accounts (IBAs). Refer to your contractor bank’s A/OPC Guide and EAS Manual for more instructions on how to set up accounts.

Typically, there are three documents you should have for each card/account holder prior to setting up a new purchase card/account:

### Delegation of Procurement Authority (DPA)
You should have a legible copy of the DPA for each prospective account holder prior to creating an account. Your agency/organization policy will dictate what the contents of the DPA should be and who has authority to issue it. 

[FAR 1.603-3(b)](https://www.acquisition.gov/far/1.603-3) states: "Agency heads are encouraged to delegate micro-purchase authority to individuals who are employees of an executive agency or members of the Armed Forces of the United States who will be using the supplies or services being purchased.” Individuals shall be appointed in writing in accordance with agency procedures.

### Training Certification
Each card/account holder must complete training prior to appointment and must take refresher training at a minimum of every three years. Card/account holders should understand their responsibilities and duties associated with having a GSA SmartPay purchase card/account. In addition, you must ensure that the card/account holder is in compliance with agency-specific policy regarding card/account holder training.

### Card/account Setup Form
Each prospective card/account holder must complete and submit an accurate card/account setup request. Card/account setup forms are located in your official contractor bank A/OPC Guide, from the contractor bank's website or EAS.

Once you receive the DPA, the training certificate, and the completed account setup form, you will review and approve/disapprove the request. Please note that you should follow any additional agency-specific requirements in setting up accounts/cards.

If you approve a request, you will then contact your contractor bank to issue the card/account to the card/account holder. Completed account forms can be sent to the bank by EAS, email, fax or mail. 
...
In cases where there is an emergency:
- The A/OPC can give verbal directions to the bank to move forward with setting up an account, followed by electronic/written confirmation to the bank within three business days.
- The A/OPC can request that the contractor bank process and send emergency and/or expedited account cards within 24 hours, including international requests. These requests include, but are not limited to, responses to natural disasters (like hurricanes and earthquakes), threats to national security, and military mobilization. The emergency accounts will arrive via overnight delivery at the contractor bank’s expense.
...
46 days from the billing date
Pre-Suspension
61 days from the billing date
Suspension/Pre-Cancellation
126 days from the billing date
Cancellation
180 days from the billing date
