...
- Printable resources such as [Helpful Hints for Purchase Account Use [PDF, 14 pages]](https://smartpay.gsa.gov/files/purchase-account-helpful-hints.pdf) is a card-sized brochure that provides information on the purchase card/account. This brochure can be ordered online and can be passed out to card/account holders when they receive their purchase cards/accounts.
