...
## How can Agency/Organization Program Coordinators (A/OPCs) and contractor banks help to minimize the risk of misuse/abuse or fraud?
A/OPCs should work to minimize the risk of misuse or fraud in your GSA SmartPay purchase program. The most important thing you can do is to be aware of what activity is occurring on the accounts under your purview. Do not be afraid to ask card/account holders questions if you identify unusual or suspicious transactions or behavior.
...
- Free online resources from the [GSA SmartPay](https://smartpay.gsa.gov/) website to assist purchase A/OPCs in detecting and preventing misuse and fraud.
- Printable resources such as [Helpful Hints for Purchase Account Use](https://smartpay.gsa.gov/sites/default/files/downloads/19-00249_19%20SmartPay%20Purchase%20Helpful%20Hints_508C.pdf) is a card-sized brochure that provides information on the purchase card/account. This brochure can be ordered online and can be passed out to card/account holders when they receive their purchase cards/accounts.


## How do these tools make it easier to audit and manage the use of purchase cards/accounts?
By providing electronic reports and transaction files, auditors and A/OPCs have immediate access to information such as merchant name, type of merchant, dollar amount of transaction and date of transaction. These tools make it easier to identify questionable transactions and follow through to ensure that the transactions were proper. In some instances, merchants also provide line item detail of transactions, including quantities, prices and product descriptions. GSA continues to work with the associations to increase availability of line item detail.
