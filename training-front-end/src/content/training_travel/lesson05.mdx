...
- Unauthorized use means the use of an account by a person, other than the account holder, who does not have actual, implied or apparent authority for such use and from which the card/account holder receives no benefit. 
