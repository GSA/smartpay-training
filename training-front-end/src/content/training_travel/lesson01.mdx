...
Specific to travel, the GSA SmartPay program provides card/account holders with a means to pay for all travel and travel-related expenses. Additionally, the GSA SmartPay program is the primary mechanism used to purchase airline, rail, and bus tickets at significantly reduced fares under the [GSA City Pair Program (CPP)](https://www.gsa.gov/travel/plan-a-trip/transportation-airfare-rates-pov-rates-etc/airfare-rates-city-pair-program). 
