...
- Limiting the length of time a card remains active, such as for the length of time the account holder is in official travel status.
...
Upon receipt of your GSA SmartPay travel account:
