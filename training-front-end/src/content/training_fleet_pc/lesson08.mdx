...
- Printable resources such as [Helpful Hints for Fleet Account Use [PDF, 10 pages]](https://smartpay.gsa.gov/files/fleet-account-helpful-hints.pdf) is a card-sized brochure that provides information on the fleet card/account. This brochure can be ordered online and can be passed out to card/account holders when they receive their fleet card/accounts.
