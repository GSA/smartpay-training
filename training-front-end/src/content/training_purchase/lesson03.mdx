...
Please note that many agencies require card/account holders to obtain management approval before each purchase. Double check your agency policy and plan time for the approval process. Tools to help you request and track approvals are available on the Purchase Publications page of the [GSA SmartPay website](www.smartpay.gsa.gov).
...
- Be sure to visit the [GSA SmartPay website](https://smartpay.gsa.gov/content/state-tax-information) to find out more about requirements in your state. 
