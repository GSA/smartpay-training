...
description: Tools for accessing and storing GSA SmartPay travel reports and statistics.
order: 5
category: travel
tags:
  - travel
...
- Identifies high risk transactions such as lost, stolen, invalid or canceled accounts, declined transactions and unusual spending activity and details such transaction activity. 
- Includes current and past due balances.
- Generally used by A/OPCs and DBO to monitor card/account holder activity, track misuse and/or identify training needs of a card/account holder.
