...
- Card/Account Holder Guide: This guide addresses authorized uses of the travel account, disputes and billing.
...
- Free online resources from the GSA SmartPay website to assist travel A/OPCs in detecting and preventing misuse and fraud.
- Printable resources such as Helpful Hints for Travel Account Use is a card-sized brochure that provides information on the travel card/account. This brochure can be ordered online and can be passed out to card/account holders when they receive their travel cards/accounts.
