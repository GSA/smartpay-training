...
[Public Law 112-194 (Government Charge Card Abuse Prevention Act of 2012) [PDF, 7 pages]](https://www.congress.gov/112/plaws/publ194/PLAW-112publ194.pdf) and [OMB Circular A-123, Appendix B [PDF, 71 pages]](https://www.whitehouse.gov/wp-content/uploads/2019/08/Issuance-of-Revised-Appendix-B-to-OMB-Circular-A-123.pdf) place a great deal of emphasis on risk management. 
...
A/OPCs may proactively implement controls to prevent or minimize the occurrence of delinquency. Controls are used to ensure proper use of the card/account and reduce risk to all parties (the card/account holder, the agency/organization and the contractor bank). These controls are often referred to as authorization controls and include:
...
- In those instances when the travel card/account is not needed on a continuous basis, deactivation of the account may serve as a deterrent to fraud and/or misuse.
- You may deactivate the card/account when a card/account holder is not using or is not planning to use the travel card/account. 
...
- Card/Account Holder Guide: This guide addresses authorized uses of the travel card/account, disputes, and billing.

### GSA Provided Resources
- GSA developed and hosts an online training course for travel card/account holders that discusses the proper use of travel card/account.
...
- Free online resources from the [GSA SmartPay website](https://smartpay.gsa.gov/) to assist travel A/OPCs in detecting and preventing misuse and fraud.
- Printable resources such as [Helpful Hints for Travel Account Use [PDF, 14 pages]](https://smartpay.gsa.gov/sites/default/files/downloads/19-00248_19%20SmartPay%20Travel%20Helpful%20Hints_508C.pdf) is a card-sized brochure that provides information on the travel card/account. This brochure can be ordered online and can be passed out to card/account holders when they receive their travel cards/accounts.

## How do program management tools make it easier to audit and manage the use of travel cards/accounts?
