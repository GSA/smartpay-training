...
- Printable resources such as [Helpful Hints for Travel Account Use [PDF, 14 pages]](https://smartpay.gsa.gov//files/purchase-account-helpful-hints.pdf) is a card-sized brochure that provides information on the travel card/account. This brochure can be ordered online and can be passed out to card/account holders when they receive their travel cards/accounts.
