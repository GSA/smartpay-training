...
### Default Limit
Standard commercial default limits suggested by the contractor during card/account setup that may be changed by an agency/organization.
...
- You may deactivate the card/account when a card/account holder is not using or is not planning to use the travel account. 
