  ...
  <div class="padding-top-4 padding-bottom-4 grid-container">
    <ul class="usa-card-group">
      <li class="usa-card tablet:grid-col-12">
        <div class="usa-card__container">
          <div class="usa-card__header">
            <h2 class="usa-card__heading">Send Invitations for GSA SmartPay Program Certification</h2>
          </div>
      ...
      <li class="usa-card tablet:grid-col-12">
        <div class="usa-card__container">
          <div class="usa-card__header">
            <h2 class="usa-card__heading">Send Follow Ups for GSA SmartPay Program Certification</h2>
          </div>
          <div class="usa-card__body">
            <p>
              ...
              <ul>
                ...
                <li>Hasn't received the last GSPC email withing 12 hours</li>
              </ul> 
            </p>
            <p>
